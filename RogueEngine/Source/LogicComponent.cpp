...
namespace Rogue
{
	...
	{
		const char* aiType[] = { "Static", "Patrol", "Finder", "Trigger",  "Platform", "Transition", "Appear on Collide", "Disappear on Collide", "UI Tele Charge 1", "UI Tele Charge 2", "UI Tele Charge 3", "Death"};
